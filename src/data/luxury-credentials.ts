...
export const luxuryCredentials: LuxuryCredential[] = [
  ...
  },
  {
    ...
    description: 'Certified expert in luxury real estate markets and high-net-worth client services',
    year: '2018',
...
export const luxuryAchievements: LuxuryAchievement[] = [
  {
    ...
    description: 'Successfully guided over 500 high-net-worth families through their real estate journey',
    metric: '500+',
    year: '2024',
    category: 'client',
    icon: '👨‍👩‍👧‍👦'
