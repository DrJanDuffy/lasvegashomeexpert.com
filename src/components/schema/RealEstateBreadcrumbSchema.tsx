...
const RealEstateBreadcrumbSchema: FC<RealEstateBreadcrumbSchemaProps> = ({
  ...
  const getBreadcrumbs = () => {
    const baseBreadcrumbs = [
      { name: 'Home', url: 'https://lasvegashomeexpert.com/' },
    ];
    ...
    switch (pageType) {
      case 'neighborhood':
        return [
          ...
          { name: `${pageName} Homes`, url: `https://lasvegashomeexpert.com/neighborhoods/${pageName.toLowerCase().replace(/\s+/g, '-')}-homes` },
        ];
      ...
      case 'service':
        return [
          ...
          { name: pageName, url: `https://lasvegashomeexpert.com/services/${pageName.toLowerCase().replace(/\s+/g, '-')}` },
        ];
      ...
      case 'guide':
        return [
          ...
          { name: pageName, url: `https://lasvegashomeexpert.com/${pageName.toLowerCase().replace(/\s+/g, '-')}` },
        ];
