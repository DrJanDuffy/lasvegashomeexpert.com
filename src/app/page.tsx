            ...
            "review": [
              {
                ...
                "reviewBody": "Dr. Duffy helped us find our dream home in Red Rock Country Club. Her expertise in luxury real estate is unmatched."
              }
            ],
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
      ...
      <section className="ai-quick-answer bg-gradient-to-r from-slate-50 to-blue-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question" className="bg-white rounded-lg p-6 shadow-md">
      ...
      <section className="social-proof bg-white py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-slate-900 mb-8">
            Trusted by 500+ Luxury Home Buyers & Sellers
          </h2>
          ...
          <div itemScope itemType="https://schema.org/AggregateRating" className="mb-12">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg p-8 max-w-2xl mx-auto">
              ...
              <div itemProp="bestRating" className="hidden">5</div>
              <div itemProp="worstRating" className="hidden">1</div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-slate-50 rounded-lg p-6">
              <h3 className="text-2xl font-semibold text-slate-800 mb-2">10+ Years</h3>
              <p className="text-slate-600">Licensed REALTOR® since 2013</p>
            </div>
            <div className="bg-slate-50 rounded-lg p-6">
              <h3 className="text-2xl font-semibold text-slate-800 mb-2">500+</h3>
              <p className="text-slate-600">Successful transactions</p>
            </div>
            <div className="bg-slate-50 rounded-lg p-6">
              <h3 className="text-2xl font-semibold text-slate-800 mb-2">$1M+</h3>
              <p className="text-slate-600">Luxury home specialist</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div itemScope itemType="https://schema.org/FAQPage" className="max-w-4xl mx-auto">
            <div itemScope itemProp="mainEntity" itemType="https://schema.org/Question" className="mb-8">
              ...
              <div itemScope itemProp="acceptedAnswer" itemType="https://schema.org/Answer">
                <p itemProp="text" className="text-slate-600 leading-relaxed">
                  <strong>Answer:</strong> Luxury homes in Las Vegas range from $1M-$25M+, with Red Rock Country Club averaging $2.1M and The Ridges averaging $2.5M as of August 2025.
                </p>
              </div>
            </div>
