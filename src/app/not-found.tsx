    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto">
          The page you're looking for doesn't exist. But don't worry! Dr. Jan Duffy is still here to
          help you find your dream home in Las Vegas.
        </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white rounded-lg p-6 shadow-lg">
            ...
            <div className="space-y-2">
              <Link
                href="/neighborhoods/red-rock-country-club-homes"
                className="block text-primary-600 hover:text-primary-700"
              >
                Red Rock Country Club
              </Link>
              <Link
                href="/neighborhoods/the-ridges-summerlin-homes"
                className="block text-primary-600 hover:text-primary-700"
              >
                The Ridges Summerlin
              </Link>
              <Link
                href="/neighborhoods/summerlin-homes"
                className="block text-primary-600 hover:text-primary-700"
              >
                Summerlin
              </Link>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/" className="btn-accent-buyer text-lg px-8 py-4">
            Go to Homepage
          </Link>
        ...
        <div className="mt-12 p-6 bg-white rounded-lg shadow-lg">
          ...
          <p className="text-slate-600 mb-4">
            If you're looking for a particular service or neighborhood, try our main navigation or
            contact Dr. Jan Duffy directly.
          </p>
