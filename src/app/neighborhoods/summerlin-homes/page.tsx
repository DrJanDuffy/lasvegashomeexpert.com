          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            <div>
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                ...
                Ridges Summerlin, and Tournament Hills, each offering unique characteristics and
                amenities. These neighborhoods feature luxury homes with golf course access,
                mountain views, and resort-style amenities. Dr. Jan Duffy's expertise in Summerlin
                luxury neighborhoods enables her to help buyers identify properties that match their
            ...
            <div>
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                Summerlin's real estate market shows strong fundamentals with 16% year-over-year
                appreciation, 58 days average on market, and 4.1 months of inventory. These metrics
                indicate a healthy market with strong demand and appreciation potential. The
                community's established reputation and ongoing development ensure continued
