        ...
        <div className="container-responsive">
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-lg text-neutral-600 leading-relaxed mb-4">
                The community's real estate market shows strong fundamentals with 13.1%
                year-over-year appreciation, 19 days average on market, and limited inventory. These
                metrics indicate a healthy market with strong demand and appreciation potential,
                making Southern Highlands an attractive investment opportunity.
              </p>
              <h3 className="text-2xl font-bold text-primary-900 mb-6 mt-8">
